...
const globals = new Set([
  'Math', 'JSON', 'Date', 'console', 'Array', 'Object', 'Intl', 'String', 'Number',
  'Boolean', 'RegExp', 'Error', 'Promise', 'window', 'global', 'globalThis', 'process',
  'require', 'undefined', 'NaN', 'ArrayBuffer', 'DataView', 'Float32Array', 'Float64Array',
  'Int8Array', 'Int16Array', 'Int32Array', 'Map', 'Set', 'WeakMap', 'WeakSet', 'Symbol',
  'Reflect', 'Proxy', 'decodeURI', 'decodeURIComponent', 'encodeURI', 'encodeURIComponent',
  'escape', 'unescape', 'eval', 'isFinite', 'isNaN', 'parseFloat', 'parseInt'
]);

const slmInternals = new Set([
  'vm', 'sp', 'content', 'extend', 'partial', 'mixin', 'j', '_b', 'require'
]);
...
export default function extractIdentifiers(code, excludeList = []) {
  ...
  cleanCode = cleanCode.replace(/\b(?:var|let|const|catch|function)\s+([a-zA-Z_$][a-zA-Z0-9_$]*)/g, "");
